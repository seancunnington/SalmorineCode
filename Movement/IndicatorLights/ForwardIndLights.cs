namespace VRTK
{
    ...
    public class ForwardIndLights : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            if (shipHullRef.GetComponent<MovePiece>().step_count_forward > 0)
            {
                if (indicator <= shipHullRef.GetComponent<MovePiece>().step_count_forward)
                {
