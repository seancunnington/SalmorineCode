namespace VRTK
{
    ...
    public class DownIndLights : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            if (shipHullRef.GetComponent<MovePiece>().step_count_up < 0)
            {
                if (indicator >= shipHullRef.GetComponent<MovePiece>().step_count_up)
                {
